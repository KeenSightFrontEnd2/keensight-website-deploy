...
export default function Footer() {
  return (
    <footer>
      <div className="flex flex-col justify-center max-w-6xl mx-auto px-4 sm:px-6 items-center text-center md:text-left lg:text-left">
        {/* Top area: Blocks */}
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
          {/* 1st block */}
          <div className="flex sm:col-span-12 lg:col-span-3 md:justify-center">
