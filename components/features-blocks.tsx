...
export default function FeaturesBlocks({ services = ourServices }) {
  return (
    <section className="relative">
      ...
      <div
        className="absolute inset-0 top-1/2 lg:mt-0 md:mt-12 bg-gray-900 pointer-events-none"
        aria-hidden="true"
      ></div>
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12">
          ...
          {/* Items */}
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-6 items-start md:max-w-2xl lg:max-w-3xl mb-4">
